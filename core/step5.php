        ...
        <div class="col-xs-12">
          ...
          <div class="row">
              ...
              <div class="col-xs-6">
                <H2>Final Cleanup</H2>
                <p>
                  Congratulations! You have successfully installed InstallSpice. You can now cleanup the install files and begin using your software. If you have any problems, you can edit the init.php directly or reinstall the app.
                </p><br><br>
