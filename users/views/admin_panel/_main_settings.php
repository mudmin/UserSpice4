<div class="row">
  <div class="col-xs-12 col-sm-6 col-md-4 col-sm-offset-1 col-md-offset-1">
    ...
    <form class="">
      ...
      <div class="panel-heading" align="center"><strong ><h4 >All Visitors</h4>(Whether logged in or not) </strong></div>
      <?php
      if (count_users() == 1) {
      ...
      ?>
            <div class="panel-heading" align="center"><strong ><h4 >All Users</h4>(Who have logged in) </strong></div>
...
The following users have logged in over the past hour...
<?php

foreach($usersHour as $v1){
  ?>
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <td><select id="track_guest" class="form-control" name="track_guest">
                          ...
                          <label for="track_guest" class="form-control"></label></select></td>
                        </tr>
