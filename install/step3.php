          ...
          <div class="row">
              ...
              <div class="col-xs-6">
                ...
                <form class="form" action="" method="post">
                  ...
                  <input required class="form-control" type="text" name="dbh"  value="<?php if (!empty($_POST['dbh'])){ print $_POST['dbh']; } ?>" required></label><br><br>

                  <label for="dbu">Database User (required)
                  <input required class="form-control" type="text" name="dbu"  value="<?php if (!empty($_POST['dbu'])){ print $_POST['dbu']; } ?>" required></label><br><br>
