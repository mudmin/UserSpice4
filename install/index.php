    ...
    <div class="row">
      ...
      <div class="col-xs-10">
        ...
        <p>
          ...
          <p>
            If you have not already created a new <font color="red"><strong>database</strong></font>, please do so at this time.  Make sure that you have the Host Name, Username, Password, and Database name handy, as you will need them to complete the install. Note that if your database user has permission to create databases on your server, the installer can create the database for you in the next step.</p>
            ...
            foreach ($php_recommended_settings as $phprec) {
              ...
              <tr>
                ...
                <td>
                  ...
                  <tr>
                    <td>PHP > 7.1.0</td>
                    <td>Yes</td>
                    <td><strong><?php if (version_compare(phpversion(), '7.1.0', '<')) {
              ...
              <?php if ($errors===0){?>
                ...
                <?php if($phpWarn ===1){ ?>
                  <br><br><font color="blue"><strong>Your PHP is out of date and you are using an unsupported version. UserSpice will work fine, but if you have the option to update to 7.1 or greater, it is strongly suggested that you do.
                  </font></strong>
                <?php } ?>
